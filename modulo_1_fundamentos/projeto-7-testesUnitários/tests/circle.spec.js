...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    // Circunferência = 2 * Pi=3,14 * raio=2 === 12.56
    ...
    // parseFloat = analisa um argumento string e retorna um número de ponto flutuante = -2 => 2
    // toPrecision = como um arredondamento. ex = 13.3714 => toPrecision(2) = 13.
