Foi recebido uma tabela não normalizada que deverá ser normalizada e populada para que possa executar queries com o intuito de encontrar as informações solicitadas.
