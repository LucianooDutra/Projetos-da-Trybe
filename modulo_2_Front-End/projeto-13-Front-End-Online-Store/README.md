...
<details><summary><b>Ilustração exemplificando o requisito:</b></summary>
...
- <details><summary> Crie uma tela que represente o carrinho de compras:</summary>
  ...
  * Adicione o atributo `data-testid` com o valor `shopping-cart-empty-message` no elemento da mensagem.
  ...
  <details><summary><b>Ilustração da tela Carrinho de Compras</b></summary>
...
- <details><summary> Na tela principal, crie um elemento que redirecione a pessoa usuária à página do carrinho de compras:</summary>
  ...
  * Adicione o atributo `data-testid` com o valor `shopping-cart-button` no elemento que redireciona à pagina de carrinho de compras. 
  ...
  <details><summary><b>Ilustração da tela principal com o elemento que redireciona para a tela do carrinho:</b></summary>
...
<details><summary>Ilustração da tela principal após uma busca por produtos:</summary>

  ![Tela principal - Após a busca](./wireframes/card_05.1.png)
</details>
<details><summary>Ilustração da tela principal caso a busca não retorne resultados:</summary>
...
<details><summary> Na tela principal, ao clicar em uma das categorias listadas, crie a listagem dos produtos dessa categoria:</summary>
  ...
  * Adicione o atributo `data-testid="product"` nos elementos que possuem os dados dos produtos;
  * :bulb: **Dica**: Lembre-se de consultar os endpoints da API para encontrar a requisição de busca por categoria (mais informações nas [orientações](#documentação-da-api-do-mercado-livre) do projeto, na seção **Desenvolvimento**).
</details><br />
...
<details><summary> Ilustração da tela de detalhes de um produto:</summary>
...
<details><summary><b>Ilustração da página principal</b></summary>
...
<details><summary> Ilustração da tela do carrinho de compras:</summary>
...
A lista de avaliações já realizadas deve persistir na tela caso a pessoa usuária saia e retorne posteriormente.

<details><summary><b> Tela de detalhes contendo o formulário para adicionar avaliações:</b></summary>

 ![Tela - Detalhamento do produto com avaliações](./wireframes/card_11.1.png)
</details>
<details><summary><b> Tela de detalhes contendo avaliações:</b></summary>
...
<details><summary> Renderize as avaliações criadas a partir do formulário:</summary>
  ...
  * Ao clicar no botão com o atributo `data-testid="submit-review-btn"`, as informações inseridas no formulário deverão ser renderizadas na tela, abaixo do formulário;
  * As avaliações devem persistir na tela. Ou seja, se a pessoa usuária sair da tela e acessar novamente, as avaliações ainda devem estar sendo renderizadas na página.
</details><br />
<details>
  <summary><strong>O que será verificado</strong></summary>

  - Avalia se é possível realizar uma avaliação na tela de detalhes de um produto
  - Avalia se a avaliação continua após recarregar a pagina
</details>
...
<details><summary><b>Ilustração contendo um exemplo de processo completo da finalização:</b></summary>
...
<details><summary><b>Ilustração da tela principal com a quantidade junto ao carrinho</b></summary>
...
<details>
  ...
  - Avalia se a quantidade de produtos no carrinho da tela de listagem é renderizada corretamente
  - Avalia se a quantidade de produtos no carrinho da tela de detalhes é renderizada corretamente
</details>
...
<details><summary> Na tela do carrinho de compras, crie um limite para a quantidade máxima dos produtos: </summary>
  ...
  * :bulb: **Dica**: Você pode encontrar esse valor na chave `"available_quantity"`, disponível na API do Mercado Livre.
</details><br />
...
<details><summary><b> Ilustração da tela de listagem dos produtos, informando quais produtos possuem frete grátis:</b></summary>

  ![Tela principal - Exibição detalhada de produto com frete grátis](./wireframes/card_15.1.png)
</details>

<details><summary><b> Ilustração da tela de detalhes de um produto, informando que possui frete grátis:</b></summary>
...
<details><summary> Adicione a informação de frete grátis aos produtos que o possuem:</summary>
  ...
  * Essa informação pode ser adicionada também à tela de detalhes, mas isso não será avaliado;
...
<details><summary> Ilustração com ordenação por preço</summary>
...
<details><summary> Listagem com carrinho populado</summary>

  ![Tela - Listagem com carrinho populado.png](./wireframes/bonus_slider.1.png)
</details>

<details><summary> Listagem com carrinho vazio</summary>
...
Destaque os produtos que já foram adicionados ao carrinho, diferenciando-os dos demais produtos da lista da página principal (veja os detalhes no card).

<details><summary> Listagem com destaque</summary>
